...
read -r -d '' json <<'EOF'
{
  ...
  "snap": [ "bandwhich", "bare", "bpytop", "core18", "core20", "core22", "core24",
    "dav1d", "dotnet-sdk", "firefox", "firmware-updater", "gnome-3-28-1804",
    "gnome-3-38-2004", "gnome-42-2204", "gtk-common-themes",
    "icon-theme-papirus", "postman", "ripgrep", "snap-store", "snapd",
    "snapd-desktop-integration", "spotify", "telegram-desktop", "vlc"
  ],
  "flatpak": [
    { "id": "app.zen_browser.zen", "repo": "flathub" },
    { "id": "com.github.finefindus.eyedropper", "repo": "flathub" },
    { "id": "com.github.hugolabe.Wike", "repo": "flathub" },
    { "id": "com.github.neithern.g4music", "repo": "flathub" },
    { "id": "com.redis.RedisInsight", "repo": "flathub" },
    { "id": "com.todoist.Todoist", "repo": "flathub" },
    { "id": "com.toolstack.Folio", "repo": "flathub" },
    { "id": "com.usebottles.bottles", "repo": "flathub" },
    { "id": "dev.bragefuglseth.Keypunch", "repo": "flathub" },
    { "id": "io.github.fabrialberio.pinapp", "repo": "flathub" },
    { "id": "io.github.flattool.Warehouse", "repo": "flathub" },
    { "id": "me.iepure.devtoolbox", "repo": "flathub" },
    { "id": "org.gnome.Calendar", "repo": "flathub" },
    { "id": "org.gnome.Cheese", "repo": "flathub" },
    { "id": "org.gnome.Chess", "repo": "flathub" },
    { "id": "org.gnome.Papers", "repo": "flathub" },
    { "id": "org.gnome.Shotwell", "repo": "flathub" },
    { "id": "page.codeberg.libre_menu_editor.LibreMenuEditor", "repo": "flathub" }
  ],
   "extensions": [
